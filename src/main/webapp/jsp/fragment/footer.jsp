        ...
        <div class="wrapper">
            ...
            <div class="col_2">
                <div class="links_group">
                    <div class="link_title">Карта сайта</div>
                    <div class="link_item"><a href="#"><fmt:message key="header.catalog"/></a></div>
                    <div class="link_item"><a href="#"><fmt:message key="header.orders"/></a></div>
                    <div class="link_item"><a href="#"><fmt:message key="header.about"/></a></div>
                </div>
            </div>
            <div class="col_3">
                <div class="links_group">
                    <div class="link_item"><a href="#"><fmt:message key="header.login"/></a></div>
                    <div class="link_item"><a href="#"><fmt:message key="header.registration"/></a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="wrapper">
            <div class="left_part">
                <div class="copy_right">2021 © «MAKIMA»<br>
                    148714  г. Минск. Октябрьская д.2</div>
            </div>
            <div class="right_part">
                <div class="en"><a href="${pageContext.request.contextPath}/controller?command=change_locale&locale=en_EN">En</a></div>
                <div class="ru"><a href="${pageContext.request.contextPath}/controller?command=change_locale&locale=ru_RU">Ru</a></div>
            </div>
        </div>
    </div>
</footer>
