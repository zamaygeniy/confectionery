...
public final class RequestAttribute {
    ...
    public static final String SUCCESSFUL_PASSWORD_EDIT = "successfulPasswordEdit";
    ...
    public static final String ERROR_WRONG_PASSWORD = "errorNoPassword";
    ...
    public static final String WRONG_CREATE_PRODUCT_DATA = "errorWrongDataMassage";
